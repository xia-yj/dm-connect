...
final class BackendWorkspace implements AutoCloseable {
    ...
    BackendWorkspace(AppContext context, ConnectionProfile profile, char[] password) {
    ...
    void release(QuerySession session) {
